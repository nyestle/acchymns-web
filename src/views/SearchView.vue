  ...
  <div @click="resetModals" class="blocker">
    ...
    <div class="search-bar">
      <input
        ...
        placeholder="Suche nach einen Titel oder Nummer..."
    ...
    <div class="filters">
      <a @click="showDropdown()" class="dropdown">
        <p class="dropdown-text">Filter</p>
    ...
    <h2 v-if="search_results.length > 0" style="margin-top: 10px; margin-bottom: 10px">
      Suchergebnisse ({{ search_results.length }})
    </h2>
    <div class="songlist">
      <RouterLink
