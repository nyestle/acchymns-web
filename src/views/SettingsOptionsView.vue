...
<template>
  <div class="menu">
    <div class="title">
      ...
      <h1 class="title--center">Benutzer Einstellungen</h1>
    </div>
  </div>
  ...
  <div class="main-content">
    ...
    <div class="settings">
      <div class="settings-option">
        <span>Gruppiere Lieder nach nummern</span>
        <label class="switch">
    ...
    <div class="settings">
      <div class="settings-option">
        <span>Überschreibe System Theme</span>
        <label class="switch">
      ...
      <div v-show="dark_mode" class="settings-option">
        <span>Invertiere Lieder Farben</span>
        <label class="switch">
    ...
    <div class="settings">
      <div class="settings-option">
        <span>Gestaffelte Wiedergabe</span>
        <label class="switch">
      ...
      <div v-show="staggered_notes" class="settings-option">
        <span class="setting-label">Wiedergabeintervall</span>
      ...
      <div class="settings-option">
        <span class="setting-label">Wiedergabedauer</span>
